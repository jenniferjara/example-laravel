		...
		<div class="col s12">
			<nav class="nav-top">
				...
				<ul class="right nav-lineal">
					<li class="nav-lineal-opt"><a id="go-products" class="nav-lineal-link" href="{{ route('home.index') }}#productos">Nuestro Producto</a></li>
...
<ul id="slide-out" class="side-nav d-none">
	<li><a id="go-products2" href="{{ route('home.index') }}#productos">Nuestro Producto</a></li>
